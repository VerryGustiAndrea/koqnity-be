...
const updatePriceBuyCustomer = (updatePriceBuyCustomer: Function, insertLogs: Function) => {
    return async function post(httpRequest: any) {
        try {
            ...
            const posted = await updatePriceBuyCustomer(Object.assign(Object.assign({}, info), { source }));
            let insertLog = await insertLogs({
                type_activity: 'update_varian_price',
