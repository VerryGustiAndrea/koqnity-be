...
const deletePriceBuyCustomer = (deletePriceBuyCustomer: Function, insertLogs: Function) => {
    return async function post(httpRequest: any) {
        try {
            ...
            const posted = await deletePriceBuyCustomer(Object.assign(Object.assign({}, info), { source }));
            let insertLog = await insertLogs({
                type_activity: 'delete_varian_price',
