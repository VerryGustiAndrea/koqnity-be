...
const addInventoryNameCustomer = (addInventoryNameCustomer: Function, insertLogs: Function) => {
    return async function post(httpRequest: any) {
        try {
            ...
            const posted = await addInventoryNameCustomer(Object.assign(Object.assign({}, info), { source }));
            let insertLog = await insertLogs({
                type_activity: 'create_inventory_name',
...
export default addInventoryNameCustomer;
