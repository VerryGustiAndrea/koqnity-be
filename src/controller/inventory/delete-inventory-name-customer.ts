...
const deleteInventoryNameCustomer = (deleteInventoryNameCustomer: Function, insertLogs: Function) => {
    return async function post(httpRequest: any) {
        try {
            ...
            const posted = await deleteInventoryNameCustomer(Object.assign(Object.assign({}, info), { source }));
            let insertLog = await insertLogs({
                type_activity: 'delete_inventory_name',
